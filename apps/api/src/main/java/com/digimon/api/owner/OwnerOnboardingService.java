...
public class OwnerOnboardingService {
    ...
    private static final String INDUSTRY_TAG_VALUES = "ELECTRONICS_MANUFACTURING, WHOLESALE_RETAIL, ACCOMMODATION_FOOD, CONSTRUCTION, INFORMATION_COMMUNICATION, ARTS_SPORTS_LEISURE";
